...
public class Main {
    /*public static void main(String[] args) {
        ...
        System.out.println(context.getPrimaryEntityInstance().getPropertyByName(p1.getName()).getValue().toString());
        System.out.println(context.getPrimaryEntityInstance().getPropertyByName(p3.getName()).getValue().toString());
